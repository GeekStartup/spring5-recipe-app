package geekstartup.springframework.spring5recipeapp.bootstrap;
...
/**
 * Created by ashishnayak on 23-Jun-2020||7:47 PM
 */
@Component
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacamoleRecipe.getIngredients().add(new Ingredient("salt", new BigDecimal(".25"), teaSpoonUom, guacamoleRecipe));
